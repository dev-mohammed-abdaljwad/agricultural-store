...
<main class="flex-grow pt-20 sm:pt-24 md:pt-28 pb-16 sm:pb-20 px-4 sm:px-6 md:px-8 max-w-7xl mx-auto w-full">
    ...
    <!-- Stats Grid -->
    <div class="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 md:gap-6 mb-8 sm:mb-12">
    ...
    <div class="bg-surface-container-lowest rounded-xl p-6 sm:p-8 editorial-shadow border border-outline-variant/15 mb-8 sm:mb-12">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-4 mb-4 sm:mb-6">
            ...
            <a href="#" class="text-primary font-bold hover:underline flex items-center gap-2 text-sm sm:text-base">
                عرض الكل
                            ...
                            <tr class="border-b border-outline-variant/15 hover:bg-surface-container-low transition-colors">
                                ...
                                <td class="px-4 sm:px-6 py-2 sm:py-3">
                                    <span class="inline-block px-2 sm:px-3 py-1 rounded-full text-xs font-bold 
                                        ...
                                        @elseif($order->status === 'quote_pending') bg-tertiary/20 text-tertiary
                                ...
                                <td class="px-4 sm:px-6 py-2 sm:py-3 hidden md:table-cell">
                                    <a href="#" class="text-primary font-bold hover:underline text-xs sm:text-sm">
                                        عرض التفاصيل
                                    </a>
                                </td>
                            </tr>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6 mb-8 sm:mb-12">
        <a href="#" class="bg-primary-fixed p-6 sm:p-8 rounded-xl border border-primary/20 hover:shadow-lg transition-all">
        ...
        <a href="#" class="bg-secondary-fixed p-6 sm:p-8 rounded-xl border border-secondary/20 hover:shadow-lg transition-all">
            <div class="flex items-start justify-between gap-4">
                <div class="flex-1">
                    <h3 class="font-headline font-bold text-base sm:text-lg text-secondary mb-1 sm:mb-2">محادثة الدعم</h3>
                    <p class="text-on-surface-variant text-xs sm:text-sm">تواصل معنا للحصول على دعم فني متخصص</p>
                </div>
